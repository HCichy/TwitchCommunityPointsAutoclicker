var frappe = (function () {
  ...
  function d(t, e) {
    return { x: Math.sin(t * Vt) * e, y: Math.cos(t * Vt) * e };
  }
  function p(t, e) {
    var i = void 0,
      n = void 0;
  ...
  function b(t, e) {
    ...
    for (var n in e) {
      ...
      if ('inside' === n) m(a).appendChild(i);
        ...
        'styles' === n
          ? 'object' === (void 0 === a ? 'undefined' : Dt(a)) &&
  ...
  function w(t, e, i, n) {
    return b('svg', { className: e, inside: t, width: i, height: n });
  }
  function A(t) {
    return b('defs', { inside: t });
  }
  function P(t) {
  ...
  function D(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : Wt,
      s =
  ...
  function S(t, e, i, n) {
    ...
    var s = b('line', {
      ...
      o = b('g', { transform: 'translate(' + t + ', 0)' });
    return o.appendChild(s), o.appendChild(r), o;
  }
  function _(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {};
    a.stroke || (a.stroke = Kt), a.lineType || (a.lineType = '');
    var s = b('line', {
        className:
          'line-horizontal ' +
          a.className +
      ...
      o = b('g', { transform: 'translate(0, ' + t + ')', 'stroke-opacity': 1 });
    return (
  ...
  function F(t, e, i) {
    ...
    var a = b('text', {
        ...
        x: 'left' === n.labelPos ? Xt : i - c(e, 5) - Xt,
        y: 0,
        dy: Jt / -2 + 'px',
        'font-size': Jt + 'px',
        'text-anchor': 'start',
  ...
  function j(t, e, i, n) {
    ...
    var o = b('text', {
        className: 'chart-label',
        x: 'left' === a.labelPos ? Xt : i - c(n + '', 4.5) - Xt,
        y: 0,
        dy: Jt / -2 + 'px',
        'font-size': Jt + 'px',
        'text-anchor': 'start',
  ...
  function V(t, e, i) {
    return Y(t, [i, 0], [e, 0], ie);
  }
  function B(t, e, i) {
    return Y(t, [0, i], [0, e], ie);
  }
  function U(t, e, i, n) {
    var a = e - i,
      s = t.childNodes[0];
  ...
  function G(t, e, i, n) {
    ...
    return (
      ...
      'rect' !== t.nodeName
        ? [
            [t.childNodes[0], { width: n, height: o }, te, ae],
            Y(
              t,
  ...
  function et(e) {
    ...
    var n = t.create('style', { innerHTML: re });
  ...
  function dt(t, e, i) {
    var n = Object.keys(ge).filter(function (e) {
        return t.includes(e);
      }),
      a = ge[n[0]];
    return Object.assign(a, { constants: e, getData: i }), new ve(a);
  }
  function pt(t) {
    if (0 === t) return [0, 0];
  ...
  function gt(t) {
    function e(t, e) {
      for (var i = vt(t), n = i[1] - i[0], a = 0, s = 1; a < e; s++)
        (a += n), i.unshift(-1 * a);
      return i;
    }
    ...
    if (n >= 0 && a >= 0) pt(n)[1], (s = i ? vt(n, a) : vt(n));
      ...
      var o = Math.abs(a),
        l = Math.abs(n);
      pt(o)[1],
        (s = (s = i ? vt(o, l) : vt(o)).reverse().map(function (t) {
          return -1 * t;
        }));
    }
    return s;
  ...
  function wt(t, e) {
    for (
      var i = Math.max.apply(Math, zt(t)), n = 1 / (e - 1), a = [], s = 0;
      s < e;
      s++
    ) {
      var r = i * (n * s);
  ...
  !(function (t, e) {
    ...
    '.chart-container{position:relative;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Fira Sans,Droid Sans,Helvetica Neue,sans-serif}.chart-container .axis,.chart-container .chart-label{fill:#bdc3c7}.chart-container .axis line,.chart-container .chart-label line{stroke:#dadada}.chart-container .dataset-units circle{stroke:#fff;stroke-width:2}.chart-container .dataset-units path{fill:none;stroke-opacity:1;stroke-width:2px}.chart-container .dataset-path{stroke-width:2px}.chart-container .path-group path{fill:none;stroke-opacity:1;stroke-width:2px}.chart-container line.dashed{stroke-dasharray:5,3}.chart-container .axis-line .specific-value{text-anchor:start}.chart-container .axis-line .y-line{text-anchor:end}.chart-container .axis-line .x-line{text-anchor:middle}.chart-container .legend-dataset-text{fill:#6c7680;font-weight:600}.graph-svg-tip{position:absolute;z-index:1;padding:10px;font-size:12px;color:#959da5;text-align:center;background:rgba(0,0,0,.8);border-radius:3px}.graph-svg-tip ol,.graph-svg-tip ul{padding-left:0;display:-webkit-box;display:-ms-flexbox;display:flex}.graph-svg-tip ul.data-point-list li{min-width:90px;-webkit-box-flex:1;-ms-flex:1;flex:1;font-weight:600}.graph-svg-tip strong{color:#dfe2e5;font-weight:600}.graph-svg-tip .svg-pointer{position:absolute;height:5px;margin:0 0 0 -5px;content:" ";border:5px solid transparent;border-top-color:rgba(0,0,0,.8)}.graph-svg-tip.comparison{padding:0;text-align:left;pointer-events:none}.graph-svg-tip.comparison .title{display:block;padding:10px;margin:0;font-weight:600;line-height:1;pointer-events:none}.graph-svg-tip.comparison ul{margin:0;white-space:nowrap;list-style:none}.graph-svg-tip.comparison li{display:inline-block;padding:5px 10px}',
    {}
  );
  var Dt =
  ...
  t.create = function (e, i) {
    ...
    for (var a in i) {
      ...
      if ('inside' === a) t(s).appendChild(n);
        ...
        'styles' === a
          ? 'object' === (void 0 === s ? 'undefined' : Dt(s)) &&
            Object.keys(s).map(function (t) {
              n.style[t] = s[t];
            })
          : a in n
  ...
  var Ht = {
        ...
        Mt(e, [
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = [];
              return (
                (t = (t || []).concat(Yt[e])).forEach(function (t) {
                  var e = Gt(t);
                  y(e)
                    ? i.push(e)
    ...
    ue = (function (t) {
      function e(t, i) {
        return (
          Ot(this, e),
          St(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i))
        );
      }
      return (
        Et(e, t),
        ...
        makeElements: function (t) {
          ...
          return (
            ...
            t.cols.map(function (t, i) {
              1 === i &&
                e.labels.push(
                  E('domain-name', o, -12, lt(n, !0).toUpperCase(), {
                    fontSize: 9,
                  })
                ),
                t.map(function (t, i) {
        ...
        animateElements: function (t) {
          ...
          return (
            this.store.map(function (a, s) {
              m = m.concat(
                G(a, e[s], i[s], t.barWidth, n[s], { zeroLine: t.zeroLine })
              );
            }),
            m
          );
        ...
        animateElements: function (t) {
          ...
          return (
            Object.keys(this.paths).length &&
              (p = p.concat(X(this.paths, e, i, t.zeroLine))),
            this.units.length &&
            ...
            value: function () {
              ...
              e.sliceTotals.map(function (i, o) {
                var l = r,
                  ...
                  y = void 0;
                t.init
                  ? ((g = v ? v.startPosition : p), (y = v ? v.endPosition : p))
                  : ((g = p), (y = f));
      ...
      return (
        ...
        Mt(e, [
          ...
          },
          {
            ...
            value: function () {
              var t = this.state;
              (t.start = at(this.data.start)),
                (t.end = at(this.data.end)),
                (t.firstWeekStart = at(t.start)),
                (t.noOfWeeks = st(t.start, t.end)),
                (t.distribution = wt(Object.values(this.data.dataPoints), 5)),
          ...
          },
          {
            ...
            value: function (t) {
              var e =
                ...
                r = { index: n, cols: [] };
              ct((e = at(e) || ut(n, a)), 1);
              for (var o = st(s, e), l = [], u = void 0, h = 0; h < o; h++)
                (u = this.getCol(s, n)),
                  l.push(u),
                  ct((s = new Date(u[he - 1].yyyyMmDd)), 1);
              return (
                void 0 !== u[he - 1].dataValue &&
                  (ct(s, 1), l.push(this.getCol(s, n, !0))),
                (r.cols = l),
                r
              );
            },
              ...
              this.data.yMarkers &&
                ...
                this.data.yRegions &&
                  (this.state.yRegions = this.data.yRegions.map(function (e) {
                    return (
                      (e.startPos = xt(e.start, t.yAxis)),
                      (e.endPos = xt(e.end, t.yAxis)),
                      e.options || (e.options = {}),
                      e
                    );
                  }));
            ...
            value: function () {
              var t = this,
                e = [
                  [
                    'yAxis',
                    { mode: this.config.yAxisMode, width: this.width },
                    function () {
    ...
    Pe = {};
  return (
    (Pe.NAME = 'Frappe Charts'),
    (Pe.VERSION = '1.1.0'),
    (Pe = Object.assign({}, Pe, Ae))
  );
})();
